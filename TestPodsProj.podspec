...
Pod::Spec.new do |s|
  s.name             = 'TestPodsProj'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TestPodsProj.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/weixiao/TestPodsProj'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'weixiao' => 'lougeweixiao@163.com' }
  s.source           = { :git => 'https://github.com/weixiao/TestPodsProj.git', :tag => s.version.to_s }
